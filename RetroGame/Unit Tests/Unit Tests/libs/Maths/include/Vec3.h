...
public:
	...
	//+===================================+//
	float GetMagnitude( const Vec3& a_pVec1 );

	//+===================================+//
	//	Normalise the Vec3
	//  returns result as a Vec3	
	//+===================================+//
	Vec3 NormaliseVec3( const Vec3& a_pVec1 );
	...
	//+===================================+//
	float DotProduct( const Vec3& a_pVec1, const Vec3& a_pVec2 );

	//+===================================+//
	//	Get the angle between two Vec3s
	//  returns a float	as degrees	
	//+===================================+//
	float GetAngle( const Vec3& a_pVec1, const Vec3& a_pVec2 );
