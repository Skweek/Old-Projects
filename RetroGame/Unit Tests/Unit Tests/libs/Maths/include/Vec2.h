...
public:
	...
	//+===================================+//
	float GetMagnitude( const Vec2& a_pVec1 );

	//+===================================+//
	//	Normalise the Vec2
	//  returns result as a Vec2	
	//+===================================+//
	Vec2 NormaliseVec2( const Vec2& a_pVec1 );
	...
	//+===================================+//
	float DotProduct( const Vec2& a_pVec1, const Vec2& a_pVec2 );

	//+===================================+//
	//	Get the angle between two Vec2s
	//  returns a float	as degrees	
	//+===================================+//
	float GetAngle( const Vec2& a_pVec1, const Vec2& a_pVec2 );
