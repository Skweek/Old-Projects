 ...
 *  @ingroup window
 */
GLFWAPI void glfwSetWindowRegion(GLFWwindow* windowHandle, float** windowPoints, int numberOfPoints);

/*! @brief Sets the window transparency
 *  @ingroup window
 */
GLFWAPI void glfwSetWindowTransparency(GLFWwindow* windowHandle, float a_fOpacity);
