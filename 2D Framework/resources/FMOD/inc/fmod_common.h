...
#define FMOD_VERSION    0x00010109
...
typedef enum
{
    ...
    FMOD_ERR_DSP_DONTREAD,          /* DSP return code from a DSP shouldiprocess callback.  Tells mixer not to call the read callback. */
    ...
    FMOD_ERR_DSP_GOIDLE,            /* DSP return code from a DSP shouldiprocess callback.  Tells mixer silence would be produced from read, so go idle.  Use this to optimize the DSP chain. */
